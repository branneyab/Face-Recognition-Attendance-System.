...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'aodiwuor@karak.ac.ke' ")
...
message3 = tk.Label(window, text="Face Recognition Attendance System" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
